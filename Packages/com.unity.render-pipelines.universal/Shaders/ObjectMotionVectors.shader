...
#define  _PrevViewProjM _PrevViewProjMatrix
            ...
            Varyings vert(Attributes input)
            {
                ...
                output.positionVP = mul(_PrevViewProjM, mul(unity_MatrixPreviousM, input.position)); // - Using previous projection matrix info to unnacount camera movement mul(UNITY_MATRIX_VP, mul(UNITY_MATRIX_M, input.position));
