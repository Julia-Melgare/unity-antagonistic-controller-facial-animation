Shader "su_VertexCol_1UV_Single"
{
    Properties
    {
        ...
        _Clip_Val("Alpha Cutoff", Range(0,1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half4 texSample = SAMPLE_TEXTURE2D(_MainTexture, sampler_MainTexture, input.uv);
                clip(texSample.a - _Clip_Val);

                // Texture * vertex colour — matches original Multiply0 = Tex2D0 * IN.color
                half3 albedo   = texSample.rgb * input.color.rgb;
